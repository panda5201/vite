...
const foodImg = [
  {
    img:
      "https://cdn-cas.orami.co.id/parenting/images/makanan_khas_mauluku-_Woku_Komo-Komo.width-800.jpg",
  },
  {
    img:
      "https://th.bing.com/th/id/OIP.o6Y4yJyS46ZQhflXgWMaEAAAAA?rs=1&pid=ImgDetMain",
  },
  {
    img:
      "https://gelartikar.com/wp-content/uploads/2021/03/ikan-asar.jpg",
  },
  {
    img:
      "https://mnews-wp.s3.ap-southeast-1.amazonaws.com/wp-content/uploads/2021/10/05134439/Papeda-khas-Papua.jpg",
  },
  {
    img:
      "https://s.kaskus.id/images/2019/09/25/10677824_20190925034816.jpg",
  },
];

const MainMenu = ({ setView }) => (
  <div className="menu">
    <h1>Makanan Tradisional Maluku</h1>
    <HoverEffect>
...
const FoodMenu = ({ setView, currentPage, setCurrentPage }) => {
  ...
  const fetchFoodData = async () => {
    try {
      setLoading(true);
      const response = await axios.get("http://localhost:3000/api/food-data-maluku");
  ...
  const fetchFact = async () => {
    try {
      ...
      const response = await axios.get(
        "http://localhost:3000/api/unique-facts-maluku"
      );
  ...
  return (
    <div className="menu">
      ...
      <div className="random-fact">
        <h2>Fakta Menarik dari Maluku</h2>
        {loading ? (
          <p>Loading...</p>
        ) : (
          <p>{randomFact}</p>
