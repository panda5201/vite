...
const foodImg = [
  {
    img:
      "https://i1.wp.com/resepkoki.id/wp-content/uploads/2018/01/Resep-Pisang-Epe.jpg?fit=1300%2C1142&ssl=1",
  },
  {
    img:
      "https://lh5.googleusercontent.com/qdCoVxWmCGypBg_KTfKZ7LpitVgdz2scqT5xE6SGO491dKYiwmDRIY550BuBJmDJTnQS3QEO2cWZc4YRpPYig2P5kmAFtH9wPbWnXYpe0yMlEH63m1Z6OCl5IxVa-r3dL-6vZ8Sm",
  },
  {
    img:
      "https://i1.wp.com/resepkoki.id/wp-content/uploads/2018/01/Resep-Kapurung.jpg?fit=1623%2C1483&ssl=1",
  },
  {
    img:
      "https://fajar.co.id/wp-content/uploads/2022/04/IMG_20220430_123652.jpg",
  },
  {
    img:
      "https://www.unileverfoodsolutions.co.id/dam/global-ufs/mcos/SEA/calcmenu/recipes/ID-recipes/fish-&-other-seafood-dishes/ikan-bakar-parape/main-header.jpg",
  },
];

const MainMenu = ({ setView }) => (
  <div className="menu">
    <h1>Makanan Tradisional Sulawesi Selatan</h1>
    <HoverEffect>
...
const FoodMenu = ({ setView, currentPage, setCurrentPage }) => {
  ...
  const fetchFoodData = async () => {
    try {
      setLoading(true);
      const response = await axios.get("http://localhost:3000/api/food-data-sulawesiselatan");
  ...
  const fetchFact = async () => {
    try {
      ...
      const response = await axios.get(
        "http://localhost:3000/api/unique-facts-sulawesiselatan"
      );
  ...
  return (
    <div className="menu">
      ...
      <div className="random-fact">
        <h2>Fakta Menarik dari Sulawesi Selatan</h2>
        {loading ? (
          <p>Loading...</p>
        ) : (
          <p>{randomFact}</p>
